...
# IMPORTANT NOTE:
# The testpypi repo has a 'semantic-retrieval' package, 
# so change name in pyproject.toml to 'semantic-retrieval-python-test' or something.
...
cd python 
rm -rf ./dist
source /opt/homebrew/Caskroom/miniconda/base/etc/profile.d/conda.sh && conda activate semantic_retrieval
