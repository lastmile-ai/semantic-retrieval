        ...
        for document in documents:
            ...
            if parser_config.metadata_db is not None:                
                ...
                if parser_config.access_control_policy_factory:
                    access_policies = parser_config.access_control_policy_factory.get_access_policies(document)

                await parser_config.metadata_db.set_metadata(document.document_id, DocumentMetadata(
