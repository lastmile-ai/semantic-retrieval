...
export class AlwaysAllowDocumentAccessPolicyFactory implements DocumentAccessPolicyFactory {
    constructor() {}

    async  getAccessPolicies(_rawDocument: RawDocument): Promise<ResourceAccessPolicy[]> {
