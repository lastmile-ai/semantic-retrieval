...
import type { Document, DocumentFragment } from "../../document/document";
...
export interface VectorDBQuery {
  ...
  // Filter retrieved DocumentFragments on some predicate
  documentFragmentFilter?: (fragment: DocumentFragment) => Promise<boolean>;
