...
export abstract class VectorDB {
  ...
  // TODO: Consider adding a retriever layer on top instead of direct query from vector db
  abstract query(accessPassport: AccessPassport, query: VectorDBQuery): Promise<Document[]>;
}
