 ...
 * Each document retriever implementation should override `_getDocumentsUnsafe` to implement their
 * custom retrieval logic and `_processDocuments` to implement desired post-processing logic.
 * The DocumentRetriever class provides a `retrieveData` method that wraps `getDocumentsUnsafe` with
