...
export interface VectorDBRetrieverQueryParams<Q extends VectorDBQuery>
  extends BaseRetrieverQueryParams<Q> {}
...
> extends BaseRetriever<R> {
  ...
  protected async getDocumentsUnsafe<Q>(
    params: VectorDBRetrieverQueryParams<Q>
  ): Promise<Document[]> {
